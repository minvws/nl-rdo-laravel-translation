...
class TranslationsCheckCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'translations:check {--update}';
    ...
    protected function calcUnfinished(array $keys): array
    {
        $max = 0;
        $ret = [];
    ...
    protected function fetchTranslationKeys(): array
    {
        $finder = new Finder();
    ...
    protected function updateTranslations(array $untranslatedTranslations): void
    {
        ...
        foreach ($files as $file) {
            ...
            $missingData = [];
            foreach ($untranslatedTranslations as $v) {
